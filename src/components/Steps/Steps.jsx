...
<section className="text-gray-600 body-font">
  <div className="container py-24 mx-auto flex md:flex-nowrap flex-wrap">
    <div className="flex relative pt-10 pb-20 sm:items-center ">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          ...
          <p className="leading-relaxed">Sign up as a donor or request blood.</p>
        </div>
      </div>
    </div>
    <div className="flex relative pb-20 sm:items-center ">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Get Matched</h2>
          <p className="leading-relaxed">Find donors or receive requests instantly.</p>
        </div>
      </div>
    </div>
    <div className="flex relative pb-20 sm:items-center ">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Save a Life</h2>
          <p className="leading-relaxed">Donate blood and make an impact!</p>
        </div>
      </div>
    </div>
  </div>
